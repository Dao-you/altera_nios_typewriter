...
(
    ...
    localparam PAD20 = log2ceil(64'h41128 - 64'h41120); 
    localparam PAD21 = log2ceil(64'h41130 - 64'h41128); 
    // -------------------------------------------------------
    ...
    // ( 0x41110 .. 0x41120 )
    if ( {address[RG:PAD19],{PAD19{1'b0}}} == 19'h41110  && read_transaction  ) begin
            src_channel = 22'b0000000000000000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
    end

    // ( 0x41120 .. 0x41128 )
    if ( {address[RG:PAD20],{PAD20{1'b0}}} == 19'h41120  && read_transaction  ) begin
            src_channel = 22'b1000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 21;
    end

    // ( 0x41128 .. 0x41130 )
    if ( {address[RG:PAD21],{PAD21{1'b0}}} == 19'h41128   ) begin
