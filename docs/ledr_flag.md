...
| 3 | `0x08` | `DISPLAY_LEDR_FLAG_CONFIRM_BLINK` | Verilog all-LEDR blink at 2 Hz for normal confirmation/wait messages. |
| 4 | `0x10` | `DISPLAY_LEDR_FLAG_ERROR_BLINK` | Verilog all-LEDR blink at 5 Hz for error confirmation/wait messages. |
